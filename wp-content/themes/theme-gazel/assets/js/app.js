...
var app = (function () {
    ...
    var _calc = function (container, modal) {
        ...
        function selectCity(searchRegion) {
            var targetObj = {'departure': '', 'destination': ''};
                ...
                targetPoint.then(function (res) {
                    ...
                    if (searchRegion != '') {
                        ...
                        if (regionExist < 0) {
                            ...
                            if (targetObj.destination != '' && targetObj.departure != '') {
                                successCity(elem);
                                getDestinationLenght(elem, destination);
                            }
                        }
