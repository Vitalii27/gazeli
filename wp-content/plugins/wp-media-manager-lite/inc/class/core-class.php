...
//          $current_blog_id = $_POST['current_blog_id'];
      ...
      public static function get_parentfolderlists($list_results){     
         ...
         if(!empty($list_results)):
                ...
                $html .= "<i class='wpmega-fedit-icons fa fa-pencil' title='Edit Folder'></i>";
                $html .= "<i class='wpmega-fdelete-icons fa fa-trash' title='Delete Folder'></i></div>";
    ...
    public function wpmediafn_html_footer(){
     ...
     echo '<div class="wpmmanager_overlay_wrap"><div id="wpmmanager-dialog-form" title="Create New Folder">
                <div class="wpmmanager_close"><i class="fa fa-close"></i></div>
                <label for="wpm_manager_folder_name">Folder Name</label>
               <hr/><input type="hidden" name="wpmm_action" class="wpmm_action_settings" value="add_folder"/>
                ...
                <input type="button" name="wpmmanager_submitbtn" class="button button-primary button-small wpmmanagersubmitbtn" value="ADD">
