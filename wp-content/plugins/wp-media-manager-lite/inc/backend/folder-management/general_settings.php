    ...
    <div class="wpmediam-container wpmediamanager-tab-container">
        <div class="row">
          ...
          <ul class="wpmediam-nav-tabs wpmediam-tabs-left">
                ...
                <li class="tab-link"><a data-tab="aboutus" class="aboutus" data-toggle="tab"><?php _e('About Us',WPMManagerLite_TD);?></a></li>
              </ul>
            </div>
...
<div class="postbox-container">
  <img src="<?php echo WPMManagerLite_IMG_DIR;?>/upgradetoprobutton.jpg"/><br/>
  <div class="wpmdia-button-wrap-backend">
        ...
        <a href="https://codecanyon.net/item/wp-media-manager-the-easiest-wordpress-media-manager-plugin/20195431?ref=AccessKeys" target="_blank" class="wpmm-upgrade-btn">Upgrade</a>
  ...
  <img src="<?php echo WPMManagerLite_IMG_DIR;?>/banner.jpg"/>
</div>
</div>
